# Contributing to miaard

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
miaard. These guidelines are not strict rules.
Use your best judgment, and feel free to propose changes to this document
in a pull request.

## Table Of Contents

- [Contributing to miaard](#contributing-to-miaard)
...
The miaard team strives to create a
...
- Pull Requests
  ...
  - PRs should be reviewed and merged in a timely fashion by the miaard technical leads
...
[issues]: https://github.com/miaard/miaard-schema/issues/
[pulls]: https://github.com/miaard/miaard-schema/pulls/
